...
public class CoordinatorTabLayout extends CoordinatorLayout {
    ...
    private int mSingleScrimColor;
    private int statusBarScrimColor;
    ...
    private void initToolbar() {
        mToolbar = findViewById(cn.hugeterry.coordinatortablayout.R.id.toolbar);
    ...
    private void setupTabLayoutAndImage() {
        if (statusBarScrimColor != 0)
            mCollapsingToolbarLayout.setStatusBarScrimColor(ContextCompat.getColor(mContext, statusBarScrimColor));
        ...
        mTabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                if (mLoadHeaderImagesListener == null) {
                    if (mImageArray != null && !singleImageMode) {
                ...
                if (singleImageMode) {
                    if (mSingleScrimColor != 0){
                        mCollapsingToolbarLayout.setContentScrimColor(ContextCompat.getColor(mContext, mSingleScrimColor));

                    }
                } else if (mColorArray != null) {
    ...
    public CoordinatorTabLayout enableSingleImageMode() {
        singleImageMode = true;
        return this;
    }

    public CoordinatorTabLayout setSingleSingleScrimColor(int color) {
        mSingleScrimColor = color;
        return this;
    }
    ...
    public CoordinatorTabLayout setStatusBarScrimColor(int statusBarScrimColor) {
        this.statusBarScrimColor = statusBarScrimColor;
        return this;
    }
}